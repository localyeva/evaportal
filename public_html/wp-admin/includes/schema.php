...
CREATE TABLE $wpdb->register_class_japanese (
   ID int(11) NOT NULL AUTO_INCREMENT,
  class_register varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  first_name varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  last_name varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  first_furigana varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  last_furigana varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  email varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  lab varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  another_inf varchar(500) COLLATE utf8_unicode_ci NOT NULL,
