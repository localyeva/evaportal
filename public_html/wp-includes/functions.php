...
function custom_pagination($numpages = '', $pagerange = '', $paged='') {
    ...
    if ($paginate_links) {
        echo "<nav class='custom-pagination' style='margin-left: 40px;'>";
...
//my function wp-auth
function my_wp_set_auth_cookie($user_id, $remember = false, $secure = '') {
    if ( $remember ) {
        /**
        ...
        $expiration = time() + apply_filters( 'auth_cookie_expiration', 60 * MINUTE_IN_SECONDS, $user_id, $remember );
        $expire = 0;
    }
