...
// end verify_user()
        ...
        function process_site_post_form() {
            if (isset($_POST)) {
                ...
                $redirect_to = '';
                if ($page_id == 'infomation-post') {
                    $redirect_to = home_url();
                } else if ($page_id == 'japanclasspost') {
                    $redirect_to = home_url() . "/japanese-class";
                } else if ($page_id == 'contactplatepost') {
                    $redirect_to = home_url() . "/contactplate-2";
                } else if ($page_id == 'document-post') {
                    $redirect_to = home_url() . "/page2-2";
                } else {
                    $redirect_to = home_url();
                }
                ...
                xxxx_update_post($post_success, get_post($post_success));
