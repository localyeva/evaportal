...
<div id="content">
    <div class="jp_class">
	    <div id="language_switch">
		    <span><a href="<?php home_url()?>./?page_id=31&lang=vi" style="text-decoration: none;">
				    <img style="width: 15px; height: auto;" src="<?php echo get_template_directory_uri(); ?>/images/classjapan/flag-vn.png">
			    </a></span>
		    <span><a href="<?php home_url()?>./?page_id=31&lang=ja" style="text-decoration: none;">
	    ...
	    <?php if (in_array($current_user->user_status, array(5, 6))): ?>
		    <div style="margin: -30px 1px 10px 580px" class="btn">
			    <a style="text-decoration: none;" href="./?page_id=199">
