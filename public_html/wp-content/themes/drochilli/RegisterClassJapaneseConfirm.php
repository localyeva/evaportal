...
<div class="row">
    <form name="class_register_conf" id="class_register" action="<?php echo esc_url(home_url('/?page_id=197')); ?>" method="post">
        ...
        <div class="col-lg-12 col-lg-offset-3">
            <div class='sub_register btn btn-warning' onclick="back_regis();" style="cursor: pointer;margin-left: 50px;">
                        <span style="font-size: 20px;font-weight: bold;">Back</span>
                    </div>
            <div class='sub_register btn btn-warning' onclick="submitformconf();" style="cursor: pointer;margin-left: 50px;">
