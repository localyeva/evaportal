...
<div class="row jp-class">
        ...
        if ($class_regis == 1 || $class_regis == 0) {
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    <tr>
                        <th><?php echo __('2015年度', 'drochilli') ?><br/><?php echo __('実施要項', 'drochilli') ?></th>
                        <td><?php echo __('年2回実施', 'drochilli') ?><br/>
    <?php echo __('2月･7月　(週3回)', 'drochilli') ?></td>
                    </tr>
                    <tr>
                        <th><?php echo __('クラス', 'drochilli') ?></th>
                        <td>
                            <?php echo __('初級クラス', 'drochilli') ?>        SFC 6:55～7:55/ 17:30～18:30 GT
    ...
    <?php echo __('※教室が確保されない場合は上記の時間のクラスを開講できない場合もあります。', 'drochilli') ?>
                    ...
                    <tr>
                        <th><?php echo __('目標', 'drochilli') ?></th>
                        <td><?php echo __('日常会話ができ、日本語能力試験N4合格', 'drochilli') ?></td>
                    </tr>
                    <tr>
                        <th><?php echo __('授業内容', 'drochilli') ?></th>
                        <td><?php echo __('場面シラバスにのっとった会話中心で行われる。', 'drochilli') ?><br/>
    <?php echo __('文法の基礎、漢字、読解、聴解', 'drochilli') ?></td>
                    </tr>
                    <tr>
                        <th><?php echo __('対象', 'drochilli') ?></th>
                        <td><?php echo __('日本語初心者～初級者', 'drochilli') ?></td>
                    </tr>
                </table>
            </div>
            <div id="class_intro_button" class="text-center">
                <a class="btn btn-warning" href="./?page_id=194&class=1"><?php echo __('申込', 'drochilli') ?></a>
            </div>
<?php } elseif ($class_regis == 2) { ?>
    ...
    <?php echo __('② 9月～11月', 'drochilli') ?>
                    ...
                    <tr>
                        <th><?php echo __('クラス', 'drochilli') ?></th>
                        <td>
                            <?php echo __('N1対策クラス', 'drochilli') ?>        SFC 6:55～7:55/ 17:30～18:30 GT
                        6:55～7:55/17:30～18:30
                        <br/>
    ...
    <?php echo __('※受講人数が5名を達しない場合は開講されません。', 'drochilli') ?>
                    ...
                    <tr>
                        <th><?php echo __('目標', 'drochilli') ?></th>
                        <td><?php echo __('日本語能力試験N1,N2合格', 'drochilli') ?></td>
                    </tr>
                    <tr>
                        <th><?php echo __('授業内容', 'drochilli') ?></th>
                        <td>
    ...
    <?php echo __('1～3回程、模擬試験を実施いたします。', 'drochilli') ?>
                    ...
                    <tr>
                        <th><?php echo __('対象', 'drochilli') ?></th>
                        <td>
                            <?php echo __('N3、旧3級取得者もしくはそれ相応レベルの日本語能力を有する者。', 'drochilli') ?>
                        </td>
                    </tr>
                </table>
            </div>
            <div id="class_intro_button" class="text-center">
                <a class="btn btn-warning" href="./?page_id=194&class=2"><?php echo __('申込', 'drochilli') ?></a>
            </div>
<?php } elseif ($class_regis == 3) { ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    <tr>
                        <th><?php echo __('2015年度', 'drochilli') ?><br/><?php echo __('実施要項', 'drochilli') ?></th>
                        <td>
                            <?php echo __('2月･6月･9月　(週2回)', 'drochilli') ?><br/>
    ...
    <?php echo __('③ 9月～11月', 'drochilli') ?>
                    ...
                    <tr>
                        <th><?php echo __('クラス', 'drochilli') ?></th>
                        <td>
                            <?php echo __('日本語ITクラス', 'drochilli') ?>        SFC 6:55～7:55/ 17:30～18:30 GT
                        6:55～7:55/17:30～18:30
                        <br/>
    <?php echo __('※受講人数が5名を達しない場合は開講されません。', 'drochilli') ?>
                        </td>
                    ...
                    <tr>
                        <th><?php echo __('目標', 'drochilli') ?></th>
                        <td><?php echo __('ITのシステム開発の現場で使える業務会話を取得', 'drochilli') ?>。</td>
                    </tr>
                    <tr>
                        <th><?php echo __('授業内容', 'drochilli') ?></th>
                        <td><?php echo __('ITの基礎知識', 'drochilli') ?> <br/>
    <?php echo __('現場で使われる会話練習', 'drochilli') ?></td>
                    </tr>
                    <tr>
                        <th><?php echo __('対象', 'drochilli') ?></th>
                        <td>
                            <?php echo __('N3、旧3級取得者もしくはそれ相応レベルの日本語能力を有する者。', 'drochilli') ?><br/>
    <?php echo __('Com,BPOスタッフ。', 'drochilli') ?>
            ...
            <div id="class_intro_button" class="text-center">
                <a class="btn btn-warning" href="./?page_id=194&class=3"><?php echo __('申込', 'drochilli') ?></a>
            </div>
<?php } else { ?>
            <div class="intro_menu">
    ...
    <?php echo __('② 12月～翌年3月', 'drochilli') ?>
                    ...
                    <tr>
                        <th><?php echo __('クラス', 'drochilli') ?></th>
                        <td>
                            <?php echo __('ビジネスクラス', 'drochilli') ?>        SFC 6:55～7:55/ 17:30～18:30 GT
                        6:55～7:55/17:30～18:30
                        <br/>
    <?php echo __('※受講人数が5名を達しない場合は開講されません。', 'drochilli') ?>
                        </td>
                    ...
                    <tr>
                        <th><?php echo __('目標', 'drochilli') ?></th>
                        <td><?php echo __('ビジネスで使える敬語、マナーを取得', 'drochilli') ?></td>
                    </tr>
                    <tr>
                        <th><?php echo __('授業内容', 'drochilli') ?></th>
                        <td>
    ...
    <?php echo __('ビジネスマネー研修', 'drochilli') ?>
            ...
            <div id="class_intro_button" class="text-center">
                <a class="btn btn-warning" href="./?page_id=194&class=4"><?php echo __('申込', 'drochilli') ?></a>
            </div>
<?php } ?>
    </div>
</div>
